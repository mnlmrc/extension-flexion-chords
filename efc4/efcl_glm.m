function varargout = efcl_glm(what, varargin)
    ...
    switch what
        case 'GLM:make_glm1'
            ...
            for d = 1:length(day)
                for chordID = chords'
                    ...
                    events.eventtype = [events.eventtype; repmat({sprintf('%d,day%d', chordID, day(d))}, [n_rep, 1])];
                end
            end
        ...
        case 'GLM:make_event'
            ...
            %% export
            output_folder = fullfile(baseDir, behavDir, 'day3');
...
%             end
        ...
        case 'GLM:design'
            ...
            Dd = dload(fullfile(baseDir,behavDir, 'day3', events_file));
       ...
       case 'GLM:across_participants'
            ...
            derivs = [0, 0];
            day = [3, 9, 23];
            vararginoptions(varargin,{'sn', 'glm', 'day','derivs'})
            
            for s=sn
               efcl_glm('GLM:within_participant', 'sn', s, 'glm', glm, 'day', day)
            end
