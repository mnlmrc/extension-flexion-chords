...
from EFC_learningfMRI.surface import project_cifti_to_surface, smooth_cifti_contrasts
from EFC_learningfMRI.repetition_suppression import save_rep_contrast_long, fit_lme
...
if __name__ == "__main__":
    ...
    # smooth_cifti_contrasts(sns, glm, stat='rep_suppr')
